...
export default function Contact() {
  return (
    <>
      <PageIntro eyebrow="Don’t worry — I’m still just a message away." title="🚧 Website under renovation">
        <p>Want to collaborate or discuss a project? Reach out below.</p>
      </PageIntro>
